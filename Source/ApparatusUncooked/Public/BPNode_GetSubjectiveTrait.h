...
#include "BPNode_GetSubjectiveTrait.generated.h"

/**
 * A user-friendly filter construction node.
 */
UCLASS(MinimalAPI)
class UBPNode_GetSubjectiveTrait
	: public UBPNode_GenericTraitFunction
{
  ...
  public:
	...
	{
		static const auto Name =  GET_FUNCTION_NAME_CHECKED(UApparatusFunctionLibrary, GetSubjectiveTrait);
		FunctionReference.SetExternalMember(
			Name, UApparatusFunctionLibrary::StaticClass());
	}
}; //-UBPNode_GetSubjectiveTrait
