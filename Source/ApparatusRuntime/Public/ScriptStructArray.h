...
struct APPARATUSRUNTIME_API FScriptStructArray
{
  ...
  public:
	...
	/**
	 * Swap an element at a specific index with a struct data.
	 * 
	 ...
	 */
	FORCEINLINE EApparatusStatus
	SwapElementAt(const int32 ElementIndex,
...
#pragma region Element Setting
	...
	SetElementAt(const int32 ElementIndex,
				 T&&         InElement)
	{
		return SwapElementAt(ElementIndex, static_cast<void*>(&InElement));
	}
