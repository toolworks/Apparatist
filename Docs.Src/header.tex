...
%%END LATEX_FONTENC
  ...
  % Branding
  \newcommand{\brandCompany}{Vladislav Dmitrievich Turbanov}
  \newcommand{\brandProduct}{$title}
  ...
  \fancypagestyle{fancyplain}{
    ...
    \fancyfoot[LO, RE]{\bfseries\scriptsize \brandCompany, Apparatus v$projectnumber }
  }
...
%%END PDF_HYPERLINKS
  ...
  \begin{figure}
    ...
    \vspace*{5cm}
    \def\svgscale{0.5}
    \input{apparatus-logo.pdf_tex}
  \end{figure}
  {\Huge \brandProduct}\\
  \vspace*{5mm}
  {\large \textit{API Reference, Version $projectnumber}}\\
  \vspace*{4.5cm}
  {\normalsize \brandCompany, \today}\\
